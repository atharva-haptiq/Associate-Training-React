  ...
  return (
    <footer className="bg-gray-950 text-gray-300 py-16 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4 text-2xl">
            ...
            <FaTwitterSquare className="hover:text-sky-500 transition duration-300 cursor-pointer" />
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">
            Subscribe for exclusive offers, giveaways, and product news.
          </p>
          <form className="mt-5 flex flex-col sm:flex-row">
            ...
            <button
              type="submit"
              className="mt-3 sm:mt-0 sm:ml-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md sm:rounded-r-md sm:rounded-l-none transition"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="mt-12 border-t border-gray-800 pt-6 text-center text-sm text-gray-500">
        ...
        <span className="text-red-500 font-semibold">ShopPro</span>. All rights
        reserved.
      </div>
    </footer>
  );
